...
class AnglesVelocities():
    ...
    def init2(self, mass_min, ind_mass_min, inds_start, inds_len, angles, velocities):
        self.mass_min = mass_min
        self.ind_mass_min = ind_mass_min
        self.inds_start = inds_start
        self.inds_len = inds_len
        self.angles = angles
        self.velocities = velocities

    def init1(self, p, N, mass_min):
